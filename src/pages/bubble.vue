<template>
  <div class="fond">
    <p v-if="showCanvas" style="font-size: xx-large">
      Cliquez sur la bulle {{ randomColorName }}
    </p>
    <canvas
      ref="canvasRef"
      width="350"
...
const colors = [
  {
    name: "Rouge",
    light: "rgba(255, 100, 100, 0.8)",
    medium: "rgba(255, 0, 0, 0.5)",
    dark: "rgba(139, 0, 0, 0.2)",
  },
  {
    name: "Vert",
    light: "rgba(100, 255, 100, 0.8)",
    medium: "rgba(0, 255, 0, 0.5)",
    dark: "rgba(0, 100, 0, 0.2)",
  },
  {
    name: "Bleu",
    light: "rgba(100, 100, 255, 0.8)",
    medium: "rgba(0, 0, 255, 0.5)",
    dark: "rgba(0, 0, 139, 0.2)",
  },
];
...
function handleClick(event: MouseEvent) {
  ...
  bubbles.value = bubbles.value.filter((bubble) => {
    const distance = Math.sqrt(
      (bubble.x - clickX) ** 2 + (bubble.y - clickY) ** 2
    );
